...
resource privateEndpoints_blob_storage_resource 'Microsoft.Network/privateEndpoints@2023-11-01' = {
  ...
  properties: {
    privateLinkServiceConnections: [
      {
        name: '${privateEndpoints_spoke3_blob_storage_name}_8c2750ac-3eff-4c30-ba89-969c8101b051'
        properties: {
    ...
    subnet: {
      id: resourceId('Microsoft.Network/VirtualNetworks/subnets', spokeNetwork[2].name, spokeName[2])
    }
    ipConfigurations: []
    customDnsConfigs: [
      {
